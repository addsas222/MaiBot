...
AMEMORIX_BASIC_FIELD_PATHS: set[str] = {
    ...
    "a_memorix.image_memory.candidate_limit",
    "a_memorix.image_memory.enabled",
    "a_memorix.image_memory.similarity_threshold",
...
AMEMORIX_ADVANCED_FIELD_PATHS: set[str] = {
    ...
    "a_memorix.image_memory.job_batch_size",
    "a_memorix.image_memory.job_enqueue_batch_size",
    "a_memorix.image_memory.job_lease_seconds",
    "a_memorix.image_memory.job_max_retries",
    "a_memorix.image_memory.job_poll_interval_seconds",
    "a_memorix.image_memory.max_bytes",
    "a_memorix.image_memory.max_pixels",
    "a_memorix.image_memory.min_train_threshold",
    "a_memorix.image_memory.preprocess_version",
    "a_memorix.image_memory.probe_retry_seconds",
    "a_memorix.image_memory.task_name",
